...
명암 대비 균일화 기법(전역 히스토그램 및 CLAHE)은 모든 아키텍처에서 Baseline 대비 f1_macro 성능을 저하시켰으며, CLAHE 적용 시 가장 낮은 성능을 기록했습니다. (Note: Context A와 Context B는 사용된 학습 데이터 양이 달라 직접 비교할 수 없습니다.)
